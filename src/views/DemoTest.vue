    ...
    <el-form class="login-container" label-position="left" label-width="0px">
      ...
      <el-form-item style="user-select: none;">
        <el-input
            ...
            v-model="demoTestService.validCode"
            @keyup.enter.native="demoTestService.judgeCode()"
        ></el-input>
        <valid-code
            ref="validCode"
      ...
      <el-form-item style="width: 100%">
        <el-button type="primary" style="width: 100%;background: #4169E1;border: none"
                   @click="demoTestService.connect()">连接websocket
        </el-button>
      </el-form-item>

      <el-form-item style="width: 100%">
        <el-button type="primary" style="width: 100%;background: #4169E1;border: none"
                   @click="demoTestService.disconnect()">关闭websocket
        </el-button>
      </el-form-item>

      <el-form-item style="width: 100%">
        <el-button type="primary" style="width: 100%;background: #4169E1;border: none" @click="demoTestService.login()">
          登录
        </el-button>
      </el-form-item>
